...
setSmallIcon: is mandatory, it is the icon in sattus bar and the small in right bottom corner of LargeIcon
setAutoCancel: clicking on notification don't kill it
setOngoing: user cannot swipe out, we can only programmatically remove it
