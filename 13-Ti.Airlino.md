...
Bonjour is invited by Apple for detecting of printer etc. in locale network. Later microsoft and android use the same protocol. The android frame has since version 16 a [NSD](https://developer.android.com/training/connect-devices-wirelessly/nsd.html) class.
